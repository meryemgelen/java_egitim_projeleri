...
public class PersonelAdresBusiness {
	...
	public PersonelAdres getPersonelAdres(int personelId) throws BusinessException {
		try {
			return new PersonelAdresDB().getPersonelAdres(personelId);
		} catch (CRUDException e) {
			throw new BusinessException(Sabitler.HATA_OKUNAMADI, e, "Personel Adresler");
		}
	}
